...
precision_metrics_test = calculate_precision_metrics("test", y_test, y_test_pred)
y_train_pred = estimator.predict(x_train)
precision_metrics_train = calculate_precision_metrics("train", y_train, y_train_pred)

confusion_metrics_test = calculate_confusion_matrix("test", y_test, y_test_pred)
confusion_metrics_train = calculate_confusion_matrix("train", y_train, y_train_pred)

os.makedirs("files/output/", exist_ok=True)

with open("files/output/metrics.json", "w", encoding="utf-8") as file:
    file.write(json.dumps(precision_metrics_train) + "\n")
    file.write(json.dumps(precision_metrics_test) + "\n")
    file.write(json.dumps(confusion_metrics_train) + "\n")
    file.write(json.dumps(confusion_metrics_test) + "\n")